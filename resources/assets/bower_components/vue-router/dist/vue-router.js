...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (Vue) {
	  ...
	  Vue.directive('link', {
	    ...
	    bind: function bind() {
	      ...
	      this.handler = function (e) {
	        ...
	        if (_this.e.tagName === 'A') {
	          ...
	          var el = e.target;
	          while (el && el.tagName !== 'A' && el !== _this.e) {
	            el = el.parentNode;
	          }
	      ...
	      this.e.addEventListener('click', this.handler);
	    ...
	    unbind: function unbind() {
	      this.e.removeEventListener('click', this.handler);
