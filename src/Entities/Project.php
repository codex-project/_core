...
use Codex\Codex;
use Codex\Contracts\Projects\Projects as ProjectsContract;
 ...
 *
 * @property \Codex\Entities\Refs $refs
 *
 * @package        Codex\Core
 * @author         Robin Radic
...
class Project extends Extendable implements Arrayable
{
     ...
     *
     * @param \Codex\Entities\Projects                      $projects
     ...
     * @param                                               $config
     */
    public function __construct($projects, $name, $config, Codex $codex, FilesystemManager $fsm, Repository $repository, Container $container)
    {
        $this->setCodex($codex);
        $this->fsm        = $fsm;
